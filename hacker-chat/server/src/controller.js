...
export default class Controller{
    ...
    async joinRoom(socketId,data){
        ...
        //atualiza o usuario corrente sobre
        //quais usuarios estao conectados na mesma sala
        this.socketServer.sendMessage(user.socket, constants.event.UPDATE_USER, currentUsers)
    ...
    broadCast({roomId, event, message, includeCurrentSocket = false}){
    ...
    #onSocketData(id) {
        return data => {
            ...
            try {
                ...
                console.error(`wron event format ! `,data.toString())
            } 
        }
    }
